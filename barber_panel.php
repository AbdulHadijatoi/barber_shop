...
include("includes/work_photos_uploader.php");
...
<body class="inner">
				...
				<div class="content-block inner">
					...
					<div class="right-content">
						<div class="center-content visible tab-content no-hscroll has-banner new-scroll">
							<form id="section1" action="barber_panel.php" method="POST" enctype="multipart/form-data" class="info-block tab">
							...
							<div class="photo-work inner tab" id="section3">
								...
								<div class="photo-list inner">
									<form class="slide" method="post" action="barber_panel.php" enctype="multipart/form-data">
										<label for="upload">
									...
									<?php if ($getWorkPhotos != null) {
										foreach ($getWorkPhotos as $photo) {	 ?>
											<div class="slide"><a href="#"><img src="images/work_photos/<?php echo $photo['photo']; ?>" alt="wp"></a></div>
									<?php }
									} ?>
								...
								<div class="table-holder">
									...
									<div class="table-wrap">
										<table class="table">
											...
											<tbody>
												<tr>
													<td><span class="text border-0">Monday 12</span></td>
												...
												<tr>
													<td>
														<span class="border-0">Martedi 13</span>
													</td>
												...
												<tr>
													<td>
														<span class=" border-0">Mercoledi 14</span>
													</td>
												...
												<tr>
													<td>
														<span class="border-0">Geovedi 15</span>
													</td>
												...
												<tr>
													<td>
														<span class="text border-0">Lunedi 12</span>
													</td>
												...
												<tr>
													<td><span class="border-0">Mercoledi 14</span></td>
												...
												<tr>
													...
													<td data-date="19 Monday" data-time="7.00" class="scheduleData">
														<span class="text">7.00</span>
														<div class="icon-box" style="visibility: <?php
																									$flag1 = false;
																									foreach ($getSchedule as $value) {
																										if ($value['date'] == '19 Monday' && $value['time'] == '7.00' && $value['availability'] == '1') {
																											$flag1 = true;
																											break;
																										} else {
																											$flag1 = false;
													...
													<td data-date="19 Monday" data-time="8.30" class="scheduleData">
														<span class="text">8.30</span>
														<div class="icon-box" style="visibility: <?php
																									$flag1 = false;
																									foreach ($getSchedule as $value) {
																										if ($value['date'] == '19 Monday' && $value['time'] == '8.30' && $value['availability'] == '1') {
																											$flag1 = true;
																											break;
																										} else {
																											$flag1 = false;
													...
													<td data-date="19 Monday" data-time="10.00" class="scheduleData">
														<span class="text">10.00</span>
														<div class="icon-box" style="visibility: <?php
																									$flag1 = false;
																									foreach ($getSchedule as $value) {
																										if ($value['date'] == '19 Monday' && $value['time'] == '10.0' && $value['availability'] == '1') {
																											$flag1 = true;
																											break;
																										} else {
																											$flag1 = false;
													...
													<td data-date="19 Monday" data-time="11.00" class="scheduleData">
														<span class="text">11.00</span>
														<div class="icon-box" style="visibility: <?php
																									$flag1 = false;
																									foreach ($getSchedule as $value) {
																										if ($value['date'] == '19 Monday' && $value['time'] == '11.0' && $value['availability'] == '1') {
																											$flag1 = true;
																											break;
																										} else {
																											$flag1 = false;
													...
													<td data-date="19 Monday" data-time="12.00" class="scheduleData">
														<span class="text">12.00</span>
														<div class="icon-box" style="visibility: <?php
																									$flag1 = false;
																									foreach ($getSchedule as $value) {
																										if ($value['date'] == '19 Monday' && $value['time'] == '12.0' && $value['availability'] == '1') {
																											$flag1 = true;
																											break;
																										} else {
																											$flag1 = false;
													...
													<td data-date="19 Monday" data-time="13.30" class="scheduleData">
														<span class="text">13.30</span>
														<div class="icon-box" style="visibility: <?php
																									$flag1 = false;
																									foreach ($getSchedule as $value) {
																										if ($value['date'] == '19 Monday' && $value['time'] == '13.3' && $value['availability'] == '1') {
																											$flag1 = true;
																											break;
																										} else {
																											$flag1 = false;
													...
													<td data-date="19 Monday" data-time="15.00" class="scheduleData">
														<span class="text">15.00</span>
														<div class="icon-box" style="visibility: <?php
																									$flag1 = false;
																									foreach ($getSchedule as $value) {
																										if ($value['date'] == '19 Monday' && $value['time'] == '15.0' && $value['availability'] == '1') {
																											$flag1 = true;
																											break;
																										} else {
																											$flag1 = false;
													...
													<td data-date="19 Monday" data-time="16.30" class="scheduleData">
														<span class="text">16.30</span>
														<div class="icon-box" style="visibility: <?php
																									$flag1 = false;
																									foreach ($getSchedule as $value) {
																										if ($value['date'] == '19 Monday' && $value['time'] == '16.3' && $value['availability'] == '1') {
																											$flag1 = true;
																											break;
																										} else {
																											$flag1 = false;
										 ...
										 ?>
											<div class="text">
												<div class="text-holder">
													...
													<div class="input-text">
														<div class="input-holder">
															<input type="text" placeholder="15" class="input-control" name="c1" id="c1" value="<?php echo $p1 ?>">
														</div>
														<strong>euro</strong>
													</div>
												</div>
												<div class="text-holder">
													...
													<div class="input-text">
														<div class="input-holder">
															<input type="text" placeholder="60" class="input-control" name="d1" id="d1" value="<?php echo $d1 ?>">
														</div>
									...
									<li>
										<div class="text">
											<div class="text-holder">
												...
												<div class="input-text">
													<div class="input-holder">
														<input type="text" placeholder="15" class="input-control" name="c2" id="c2"  value="<?php echo $p2 ?>">
													</div>
													<strong>euro</strong>
												</div>
											</div>
											<div class="text-holder">
												...
												<div class="input-text">
													<div class="input-holder">
														<input type="text" placeholder="60" class="input-control" name="d2" id="d2" value="<?php echo $d2 ?>">
													</div>
													<strong>minutes</strong>
												</div>
											</div>
									...
									<li>
										<div class="text">
											<div class="text-holder">
												...
												<div class="input-text">
													<div class="input-holder">
														<input type="text" placeholder="15" class="input-control" name="c3" id="c3" value="<?php echo $p3 ?>">
													</div>
													<strong>euro</strong>
												</div>
											</div>
											<div class="text-holder">
												...
												<div class="input-text">
													<div class="input-holder">
														<input type="text" placeholder="60" class="input-control" name="d3" id="d3" value="<?php echo $d3 ?>">
													</div>
													<strong>minutes</strong>
												</div>
											</div>
							...
							<div id="section9" class="info-block tab">
								<div class="heading-holder">
									...
									<strong class="heading">Mappa </strong>
								</div>
								<div class="map-bar">
									<div class="col">
										<div class="radius-away">
											<strong class="title">Raggio</strong>
									...
									<div class="col">
										<div class="input-flex">
											<div class="input">
												<strong class="title">Indirizzo dove vuoi lavorare</strong>
												<input type="text" class="input-control" value="Via Della Cicala, 25">
											</div>
											<div class="input">
												<div class="dropdown">
													<a href="#" class="sort-opener">Ordina per</a>
													<div class="drop">
							...
							<div id="section10" class="info-block tab">
								...
								<div class="info-cols">
									<div class="col">
										<form action="barber_panel.php" id="changeEmailForm" method="POST">
											<div class="input">
												<strong class="title">Edit email</strong>
												<input type="email" class="input-control" name="oldEmail" placeholder="Old email">
											</div>
											<div class="input">
										...
										<form action="barber_panel.php" id="changePassForm" method="POST">
											<div class="input">
									...
									<form action="barber_panel.php" method="POST" class="col">
	...
	<script>
		...
		function toggleAvailability(myTime, myDate, checkValue) {
			...
			request.open("POST", "includes/set_availability.php");
			...
			request.onreadystatechange = function() {
				...
				function updatePriceList(t,c,d, a, userid) {
					...
					if(cost.value != "" && duration.value != ""){
						var request = new XMLHttpRequest();
						request.open("POST", "includes/update_pricelist.php");
						// Retrieving the form data
